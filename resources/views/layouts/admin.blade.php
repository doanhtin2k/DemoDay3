...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="{{route('home.admin')}}">Dashboard</a></li>
        </ul>
      </li>
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="{{route('category-admin.index')}}">Category</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
          <a href="{{route('book-admin.index')}}">
    ...
    <div class="profile-details">
      ...
      <div class="name-job">
        <div class="profile_name"><a href="{{route('logout.admin')}}">Logout</a></div>
      </div>
  ...
  <section class="home-section">
    ...
    <h1 style="text-align:center">@yield("chu-de")</h1>
          @yield("main")
    </div>
  </section>
  <script>
